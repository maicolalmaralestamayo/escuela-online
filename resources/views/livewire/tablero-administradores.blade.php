                 ...
                 <div class="card">
                     <div class="card-header">
                         ...
                         <div class="card-tools">
                             ...
                             <button type="button" class="btn btn-tool" data-lte-toggle="card-remove" title="Cerrar">
                     ...
                     <div class="card-body table-responsive">
                         ...
                         @livewire('tabla', ['columnas' => ['nombre_1' =>'Nombre', 
                                                            'nombre_2' => 'Segundo nombre',
                                                            'apellido_1' => 'Apellido',
                                                            'apellido_2' => 'Segundo Apellido',
                                                            'dni' => 'DNI'],
                                             'modelo' => 'Administradors'], key('tabla-usuarios'))
